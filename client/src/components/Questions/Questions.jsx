        ...
        <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gray-50 dark:bg-gray-900">
            <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-6 sm:gap-8 lg:gap-12">
                    <div className="bg-custom-blue text-white p-6 sm:p-8 lg:p-10 rounded-xl shadow-lg flex flex-col items-start space-y-4 sm:space-y-6 order-2 lg:order-1">
                        ...
                        <a href="#footer" className="mt-4 inline-flex items-center justify-center rounded-full bg-white hover:bg-gray-50 text-custom-blue px-6 sm:px-8 py-3 sm:py-3.5 text-sm sm:text-base font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
                            Связаться с нами
                        </a>
                    </div>
                    <div className="order-1 lg:order-2 flex items-center justify-center">
                        <img src={questionsImg} alt="Вопросы" className="w-full h-auto rounded-xl shadow-lg" />
                    </div>
                </div>
            </div>
        </section>
